...
class AgentConfig(BaseModel):
	...
	minimum_time_between_posts_hours: int = Field(description="The minimum time since the agent's last posts in hours before it can make another post.", default=1)
